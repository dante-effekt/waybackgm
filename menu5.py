    ...
    for event in joystick.read_loop():
        ...
        if event.type == ecodes.EV_ABS and event.code == 17:
            if event.value == 1:
                ...
                coordenadas_label.config(text=f"Coordenadas: (0, {y})")
...
coordenadas_label = Label(app, text="", font=("Courier", 10))
coordenadas_label.pack(side="bottom", pady=1)
