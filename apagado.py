...
# Botón de apagar
btn_apagar = tk.Button(ventana, text="Apagar", command=apagar, bg="red", fg="white", image=icono_apagar, compound="left")
btn_apagar.pack(pady=10)

# Botón de reiniciar
btn_reiniciar = tk.Button(ventana, text="Reiniciar", command=reiniciar, bg="yellow", fg="black", image=icono_reiniciar, compound="left")
